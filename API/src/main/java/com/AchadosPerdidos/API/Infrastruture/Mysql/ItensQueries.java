...
import com.AchadosPerdidos.API.Infrastruture.Mysql.Interfaces.IItensQueries;
...
public class ItensQueries implements IItensQueries {
    ...
    private final RowMapper<Itens> rowMapper = new RowMapper<Itens>() {
        @Override
        public Itens mapRow(ResultSet rs, int rowNum) throws SQLException {
